...
using Hansol_Chemical_NFC.Droid;
using System;
using System.Linq;
...
[assembly: Dependency(typeof(Class_NFC))]
namespace Hansol_Chemical_NFC.Droid
{
    ...
    public class Class_NFC : Services.INFC_Interface
    {
        ...
        public void StartSearching()
        {
            ...
            if (_nfcAdapter == null)
            {
                ...
                MessagingCenter.Send<App, string>(scanApp, "ERROR", "이 기기는 NFC 기능을 지원하지 않습니다.");
            ...
            else
            {
                ...
                var intent = new Intent(Android.App.Application.Context, GetType()).AddFlags(ActivityFlags.SingleTop);
                ...
                _nfcAdapter.EnableForegroundDispatch(MainActivity.Instance, pendingIntent, filters, null);
            }
        }
